...
public class ExitoLogin extends SimpleUrlAuthenticationSuccessHandler{
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		/*
		 * Usamos está forma porque no se puede inyectar como argumento en el método
		 * el RedirectAttributes flash como se puede hacer en el controlador
		 * 
		 */
		...
		//hereda de HashMap. Usamos el objeto authentication que se pasa como argumento para mostrar el nombre
